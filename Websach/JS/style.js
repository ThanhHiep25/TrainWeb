...
function printReceipt(bookId) {
    ...
    var pay = document.getElementById('totalAmount').value;
    ...
    // Lấy phần tử HTML chứa nội dung giỏ hàng
    
     // Thêm nội dung giỏ hàng vào cửa sổ mới 
   
    newWindow.document.write(cartElement.innerHTML);
...
function clearCart() {
    ...
    updateTotal(0);
    // Thông báo thành công
    showNotification2('Đã xóa giỏ hàng thành công.')
...
function pay() {
    ...
    if (cartList.childElementCount === 0) {
        showNotification3('Giỏ hàng của bạn trống. Vui lòng chọn sách để thanh toán.')
        return false;
    }
...
function showNotification2(message2) {
    ...
    var notificationMessage2 = document.getElementById('notification-message2');

    // Gán nội dung cho phần tử p
    notificationMessage2.textContent = message2;
...
function showNotification3(message3) {
    ...
    var notificationMessage3 = document.getElementById('notification-message3');

    // Gán nội dung cho phần tử p4
